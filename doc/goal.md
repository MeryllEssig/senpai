...
Each project carries a single manifest file, `.aimanager.jsonc`, that declares the context an AI agent needs to interact with the project's ecosystem: ticket trackers, code hosting, repositories and components, environments, documentation locations, bounded executable capsules, and rules mapping intents to capsules or external-tool skills.
